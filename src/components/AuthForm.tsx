                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <div className="relative w-20 h-20">
                        <img src={companyLogo} alt="logo" className="w-20 h-20 rounded-full border-2 border-solid" />
                        <CircleArrowUp className="absolute top-11 right-0 opacity-50 z-index:999" />
                        <input type="file" id="file" onChange={handleImageUpload} className="w-10 h-20 absolute top-11 right-0 z-index:99 opacity-0" />
                      </div>
